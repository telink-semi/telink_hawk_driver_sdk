...
#define FLASH_PAGE_ERASE   				3  //< only 8359 support
#define FLASH_SECTOR_ERASE   			4
#define FLASH_32KBLOCK_ERASE   			5
#define FLASH_64KBLOCK_ERASE 			6
#define FLASH_CHIP_ERASE 				7
#define FLASH_DEEP_POWER_DOWN 			8
#define FLASH_RELEASE_DEEP_POWER_DOWN 	9
#define FLASH_STATUS_READ 				10
#define FLASH_STATUS_WRITE 				11
#define FLASH_UID_READ 					12

#define FLASH_MODE			    		12
